...
hh=[50,125,175,225,275,325,375,425,475,525,575,625,675,725,775,850,950]
o3_nm_m=df4.groupby('Heightgroup_NM').mean().dO3_NM
o3_hw_m=df4.groupby('Heightgroup_HW').mean().dO3_HW
o3_nm_sd=df4.groupby('Heightgroup_NM').std().dO3_NM
o3_hw_sd=df4.groupby('Heightgroup_HW').std().dO3_HW
nox_nm_m=df4.groupby('Heightgroup_NM').mean().dNOx_NM
nox_hw_m=df4.groupby('Heightgroup_HW').mean().dNOx_HW
nox_nm_sd=df4.groupby('Heightgroup_NM').std().dNOx_NM
nox_hw_sd=df4.groupby('Heightgroup_HW').std().dNOx_HW
